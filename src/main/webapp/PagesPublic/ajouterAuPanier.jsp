...
try{
	...
	if(z==1){
		...
		response.sendRedirect("../PagesPublic/home.jsp?msg=exist");
	}
	if(z==0){
		...
		ps.executeUpdate();
		response.sendRedirect("../PagesPublic/home.jsp?msg=added");

	}

	}
catch(Exception e){
	response.sendRedirect("../PagesPublic/home.jsp?msg=invalid");
