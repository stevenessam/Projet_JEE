...
try
{
	...
	if(quantity==1 && incdec.equals("dec"))
		response.sendRedirect("../PagesPublic/panier.jsp?msg=notPossible");
	else if(quantity !=1 &&  incdec.equals("dec"))
	{
		...
		response.sendRedirect("../PagesPublic/panier.jsp?msg=dec");
	}
	else
	{
		total=total+price;
		quantity=quantity+1;
		st.executeUpdate("update cart set total='"+total+"',quantity='"+quantity+"' where email='"+email+"' and product_id='"+id+"'and address is NULL");
		response.sendRedirect("../PagesPublic/panier.jsp?msg=inc");
